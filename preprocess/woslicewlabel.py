...
class WOSliceWlabelDataset(BaseDataset):
    def __init__(self, cfg):
        super(WOSliceWlabelDataset, self).__init__(cfg)
    ...
    def __getitem__(self, idx):
        ...
        interaction = torch.cat((interaction, torch.tensor(temp_dict["label"])),dim=-1)
